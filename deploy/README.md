...
```shell
docker image inspect ghcr.io/niyan-project/niyan:0.6.0 --format '{{index .RepoDigests 0}}'
```
...
| Variable | Meaning |
| --- | --- |
| `NIYAN_IMAGE` | Exact Niyān image tag. Prefer a complete release such as `0.6.0`; record the resolved digest. |
...
```shell
docker pull ghcr.io/niyan-project/niyan:0.6.0
```
