...
class NiyanFileSystem(AbstractFileSystem):
    ...
    def __init__(self, *, host: str | None = None, dataset: str | None = None, revision: str | None = None, token: str | None = None, timeout: float = 30, environment: dict[str, str] | None = None, cwd: str | os.PathLike[str] | None = None, paths: Any = None, stores: Any = None, api_factory: Callable[..., ApiClient] = ApiClient, **storage_options: Any) -> None:
...
class _ResolvedPath:
    ...
    def __init__(self, *, api: ApiClient, host: str, dataset_id: str, dataset_path: str, repository_path: str, resolved_commit: str) -> None:
        self.api = api
        self.host = host
