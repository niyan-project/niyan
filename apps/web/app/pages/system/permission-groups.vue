...
<template>
  <SystemShell>
    <div class="flex items-start justify-between gap-4"><div><h1 class="text-2xl font-medium text-highlighted">Permission groups</h1><p class="mt-1 text-muted">Bundle permissions that control delegated access to System.</p></div><UButton v-if="canAdd" label="New group" icon="i-lucide-plus" @click="openForm()" /></div>
