...
NIYAN_GIT_HTTP_MAX_REQUEST_BYTES = env.int('NIYAN_GIT_HTTP_MAX_REQUEST_BYTES', default=4 * 1024 * 1024 * 1024)
...
if NIYAN_GIT_HTTP_MAX_REQUEST_BYTES < 1:
    raise ImproperlyConfigured('NIYAN_GIT_HTTP_MAX_REQUEST_BYTES must be positive.')
