...
Niyān publishes versioned container images to GitHub Container Registry. Always deploy an exact semantic version such as `0.6.0`; do not base production on `latest`.
